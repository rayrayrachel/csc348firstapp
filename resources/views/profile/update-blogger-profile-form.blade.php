                ...
                <section>
                    ...
                    <form method="POST" action="{{ route('blogger.profile.update') }}" class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="bio" name="bio" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                placeholder="Write your bio here">{{ old('bio', $bloggerProfile->bio) }}</textarea>
                        ...
                        <div>
                            ...
                            <x-text-input id="website" name="website" type="url" class="mt-1 block w-full"
                                placeholder="https://example.com" :value="old('website', $bloggerProfile->website)" />
                        ...
                        <div>
                            ...
                            <x-text-input id="location" name="location" type="text" class="mt-1 block w-full"
                                placeholder="City, Country" :value="old('location', $bloggerProfile->location)" />
                        ...
                        <div>
                            ...
                            <x-text-input id="date_of_birth" name="date_of_birth" type="date" class="mt-1 block w-full"
                                :value="old('date_of_birth', $bloggerProfile->date_of_birth)" />
